...
Welcome to [report Issues](https://github.com/Tencent/MedicalNet/issues) or [pull requests](https://github.com/Tencent/MedicalNet/pulls). It's recommended to read the following Contributing Guide first before contributing. 
...
## License
By contributing to MedicalNet, you agree that your contributions will be licensed
under its [MIT LICENSE](https://github.com/Tencent/MedicalNet/blob/master/LICENSE)